...
public class Validity {
    ...
    public static final String CUSTOMER_ID = "^[0-9][0-9]$";
//    public static final String PASSWORD_REGEX = "^([a-zA-Z0-9]{8,})";
    ...
    public static final String CONFIRM_REGEX = "^[yn]$";
...
//    }
    ...
    public static boolean isCustomerIDValid (String id) {
        return Pattern.compile(CUSTOMER_ID).matcher(id).matches();
    }
    ...
    public static boolean isConfirmValid (String confirm) {
        return Pattern.compile(CONFIRM_REGEX).matcher(confirm).matches();
    }
}
